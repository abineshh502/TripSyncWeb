...
export default function GroupDetailsPage() {
  ...
  // Map tab routing builder states
  ...
  // Chat tab real-time sync subscription
  useEffect(() => {
  ...
  // Load route polylines when day or itinerary changes
  useEffect(() => {
    ...
    if (spots.length >= 2) {
      travelApiService.fetchOSRMRouteCoords(spots).then((coords) => {
        ...
        setRouteDistanceM(spots.length * 12000); // simulated metrics
  ...
  // Action: Save Itinerary Day Plans
  ...
  // Add waypoint spot to Day Itinerary
  ...
  // Delete spot from Day Itinerary
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {activeTab === "expenses" && (
          <div className="lg:col-span-3 space-y-6">
            ...
            {/* Settlements and Expense List Grid */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Left col: Net settlements checklist */}
              <div className="lg:col-span-1 space-y-4">
                <div className="glass-panel p-5 rounded-2xl border border-white/5 space-y-4">
                  <h3 className="text-white font-semibold text-sm flex items-center gap-1.5">
        ...
        {/* ── Tab 5: Chat (WhatsApp style Group Chat) ────────── */}
        {activeTab === "chat" && (
          <div className="lg:col-span-3 flex flex-col h-[65vh] bg-slate-950/40 border border-white/5 rounded-2xl overflow-hidden relative">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4 min-h-[300px]">
              {messagesList.map((m, idx) => {
                ...
                // Read tick ticks: if readBy has other members
